...
export const metadata = {
  ...
  description:
    'Track your YouTube channel performance, get insights, and grow your audience with our comprehensive analytics platform.',
}
...
const features = [
  {
    ...
    description:
      'Get instant insights into your channel\'s performance with real-time data updates.',
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      'Understand your viewers better with detailed demographic and behavioral data.',
    icon: (
      <svg
        className="h-6 w-6 text-primary"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Track your competitors\' performance and identify opportunities for growth.',
    icon: (
      <svg
        className="h-6 w-6 text-primary"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Get recommendations to optimize your content and improve engagement.',
    icon: (
      <svg
        className="h-6 w-6 text-primary"
        fill="none"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
              Everything you need to understand your channel's performance and grow your
              audience.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-lg text-primary-foreground">
              Start tracking your analytics today and make data-driven decisions to grow
              your audience.
            </p>
            <div className="mt-8">
